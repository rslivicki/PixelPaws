...
Mouse walking/locomoting through the arena.
...
## See also
- `../classifiers/classifier_walking.pkl` — model artefact (load with joblib)
- `../performance_results/walking/training_metrics.json` — full metrics + sweep results
- `../performance_results/walking/oof.npz` — out-of-fold probabilities (for plot regen / re-sweep)
