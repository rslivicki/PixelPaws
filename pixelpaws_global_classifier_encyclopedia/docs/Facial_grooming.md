...
Mouse grooms the face with one or both forepaws.

## v1 status
- **CV-F1 (mean ± std)**: 0.900 ± 0.038
- **Inclusion gate**: 0.85 frame F1 — **PASSES** (0.900 ≥ 0.85)
...
- Performance panels (threshold curve, SHAP beeswarm, confusion matrix):
  ...
  `../performance_results/Facial_grooming/`.
...
## Source pkl
Original: `260506_RS_THC_Withdrawal` cohort. See `../classifiers/classifier_Facial_grooming.pkl`
