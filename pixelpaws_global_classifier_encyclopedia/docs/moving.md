...
Mouse moving through the arena (walking or running).

## Performance
- **Frame F1 (CV)**: 0.783 ± 0.046
- **Bout F1 (post-optimized)**: 0.791
...
## See also
- `../classifiers/classifier_moving.pkl`, model artefact (load with joblib)
- `../performance_results/moving/training_metrics.json`, full metrics + sweep results
- `../performance_results/moving/oof.npz`, out-of-fold probabilities (for plot regen / re-sweep)
