...
Mouse grooms torso/back/belly area with forepaws or by twisting around.
...
## See also
- `../classifiers/classifier_body_grooming.pkl` — model artefact (load with joblib)
- `../performance_results/body_grooming/training_metrics.json` — full metrics + sweep results
- `../performance_results/body_grooming/oof.npz` — out-of-fold probabilities (for plot regen / re-sweep)
