...
pp_runtime.resolve_pose_python(), because the GUI's own interpreter may not have
...
def _fallback_analyze(vp: Path, device: str):
    ...
    try:
        from pp_config import POSE_DLC_CONFIG, POSE_SHUFFLE, POSE_DLC_BATCH   # lab module: absent in a release
    except ImportError:
        return None
    try:
        import deeplabcut
