...
# The seaborn style/palette is applied in main() only: the GUI imports this
# module for its plot functions, and a module-level plt.style.use() restyled
# every figure the app drew afterwards.
...
def main():
    """Main function"""
    # Set style (CLI only; see the note at the imports)
